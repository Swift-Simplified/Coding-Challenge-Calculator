...
//
// → What's This File?
//   This file contains a manager, which builds an equation as the user presses buttons on the
//   virtual keypad. It also maintains a display updated by each press of the keypad.
...
class EquationBuilder: EquationBuilding {
    ...
    private func appendNewDecimal(_ number: Int, toPreviousEntry previousInput: Decimal) -> (decimal: Decimal, stringRepresentation: String) {
        ...
        // handle a special case where the user is entering an unfinished decimal i.e. "0.0000"
